              ...
              <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:'Basier Circle', 'Roboto', 'Helvetica', 'Arial', sans-serif;font-size:1em;line-height:1.37em;color:#384049;">
                ...
                <tr>
                  <td style="padding:30px;background-color:#ffffff;">
                    ...
                    <p>Welcome to Christian Reals, your number one Christian dating network!</p>
                    <p>Please verify your email to become part of this growing community of single Christians.</p>
                    <p>In almost no time, you'll be connecting instantly with other like-minded single Christians.</p>
                    <p>To verify your email, please click on this link:</p>
                    <p style="text-align: center;margin: 2.5em auto;">
                      <a class="button" href="https://christianreals-backend.onrender.com/verify/?token=${token}" style="background: #DE4D3B; 
                    ...
                    <p>Please ignore this message and delete it if it’s not for you or if you’ve received it in error.</p>
                    <p>Thanks and God bless,</p>
                    <p>The Christian reals Team</p>
                  </td>
                </tr>
                <tr>
...
const sendNotificationEmail = async (email,message,notificationType,sender,SenderAvatar,date) => {
  ...
  let mailOptions = {
    from: '"Christainreals.com" <ayomikunfaluyi@gmail.com>',
    to: email,
    subject: notificationType == message ? 'New Message': 'New Notification',
    html: `
    <!DOCTYPE HTML>
    <html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office">
...
module.exports = {sendVerificationEmail,sendEventRegistrationEmail,sendResetPasswordEmail,sendNotificationEmail};